...
function createForm() {
  ...
  nameInput.value = 'Tester Testo';

  const emailInput = document.createElement('input');
  emailInput.type = 'email';
  emailInput.name = 'email';
  emailInput.value = 'tester2@testo.org';

  const telInput = document.createElement('input');
  telInput.type = 'tel';
  telInput.name = 'phone_number';
  telInput.value = '12345663';

  const tagsInput = document.createElement('input');
  tagsInput.type = 'text';
  tagsInput.name = 'tags';
  tagsInput.value = 'tester';

  form.replaceChildren(nameInput, emailInput, telInput, tagsInput);
